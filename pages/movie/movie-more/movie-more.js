var { getMovieData } = require('../../../utils/util.js');
var app = getApp();
Page({
  ...
  onLoad: function (options) {
    ...
    getMovieData(url, this.handleMovieList);
  },
  ...
  onPullDownRefresh: function () {
    var _this = this;
    wx.showNavigationBarLoading();
    getMovieData(this.data.requestUrl, function (data) {
      _this.setData({
        movie: data
      })
      wx.hideNavigationBarLoading();
  ...
  onReachBottom: function () {
    ...
    wx.showNavigationBarLoading();
    getMovieData(nextUrl, this.handleMovieList)
  },
})